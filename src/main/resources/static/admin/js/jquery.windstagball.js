...
;(function ($) {
    $.fn.windstagball = function (options) {
        ...
        sbody.addEventListener("touchstart", trueActive);
        sbody.addEventListener("touchend", falseActive);
        function trueActive() {
            // mouseX = Math.ceil(Math.random() * 500) / 5;
            // mouseY = Math.ceil(Math.random() * 500) / 5;
       ...
       /* $('body').on('touchmove', function () {
            active = true;
            mouseX = Math.ceil(Math.random() * 10) / 5;
            mouseY = Math.ceil(Math.random() * 10) / 5;
        });
        ...
        myInterval = setInterval(setPosition, 30);
